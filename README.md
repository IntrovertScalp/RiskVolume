...
**Приложение для управления рисками, расчета объема позиции в зависимости от % Stop Loss и автоматической расстановки значений в ячейки объёмов (Пресетов) в стакане ⚡**
